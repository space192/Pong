...
#include "time.h"    //test for gettimeofday  version dos fifi//
...
float chrono(int action)  //version dos chrono à la seconde//////////////
	{
	static double ch = 0.0;
	double current;
	float delta;
	time_t tv;   //version dos////////////////////////////////////////////
	//struct timeval tv;    //version unix
	
	//gettimeofday(&tv,NULL);    //version unix
	tv=time(NULL);               //version dos////////////////////////////
	
	//current = tv.tv_sec + (float)(tv.tv_usec)*1e-6; //version unix
	current = tv; //version dos /////////////////////////////////////////
...
int heure()
	...
	//gettimeofday(&tv,NULL);    //version unix
	tv=time(NULL);               //version dos////////////////////////////
	//stm = localtime((time_t *)&(tv.tv_sec));  //versin unix
	stm = localtime((time_t *)&(tv)); //version dos /////////////////////
	return stm->tm_hour;
	}
